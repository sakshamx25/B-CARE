  ...
  return (
    <footer className="bg-gradient-to-b from-slate-900 to-gray-900 text-white">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Link
          to="/register/donor"
          className="flex items-center gap-2 px-6 py-4 bg-gradient-to-r from-blue-600 to-red-700 text-white font-semibold rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 hover:from-red-700 hover:to-red-800"
        >
