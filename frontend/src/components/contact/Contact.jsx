    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 px-6">
          ...
          <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
            ...
            <p className="text-gray-600">+91 8433146639</p>
          ...
          <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
            ...
            <p className="text-gray-600">support@b-care.org</p>
            <p className="text-gray-600">info@b-care.org</p>
          </div>
          ...
          <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
            ...
            <p className="text-gray-600">GLA UNIVERSITY, MATHURA</p>
            <p className="text-gray-600">India - 281406</p>
          </div>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">+91 8126995464</span>
              </div>
              <div className="flex items-center">
                <Mail className="text-red-600 mr-3" />
                <span className="text-gray-700">support@b-care.org</span>
              </div>
              <div className="flex items-center">
                <MapPin className="text-red-600 mr-3" />
                <span className="text-gray-700">GLA University, Mathura</span>
              </div>
            </div>
      ...
      <section className="mb-5">
        <iframe
          ...
          src="https://maps.google.com/maps?q=GLA%20University%20Mathura%20Uttar%20Pradesh&output=embed"
          allowFullScreen
        ></iframe>
      </section>
